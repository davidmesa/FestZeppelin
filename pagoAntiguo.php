<?php
	...
	if ($contestada) {
		...
		if($ok)
		{
			$to = 'david.mesa@festzeppelin.com';
		    $subject = 'Inscrito a la pag';  
		    ...
		    $headers = "From: info@festzeppelin.com\r\n";
		    $headers .= 'Content-Type: text/plain; charset=utf-8';
		    $email = filter_input(INPUT_POST, 'email', FILTER_VALIDATE_EMAIL);
			if ($email) {
			   $headers .= "\r\nReply-To: $email";
			}
		    $success = mail($to, $subject, $message, $headers, '‑fdavid.mesa@festzeppelin.com');
		}
	}
?>
<!DOCTYPE html>
	        ...
	        <div id="contenidoLoading" class="center">
	          <h2 class="ui inverted icon header">
	            <?php if (isset($success) == false){echo '<i class="sun loading icon"></i>';} ?>
	           	...
	           	<?php if (isset($success) && $success){echo '<i class="thumbs outline up icon"></i>';} ?>
	           	<?php if (isset($success) && ($success == false)){echo '<i class="doctor icon"></i>';} ?>
	           	<?php if (isset($success) && $success){echo 'Listo! Te contactaremos pronto.';} ?>
		...
		<div class="ui page grid">
			<div class="sixteen wide column">
				...
				<div class="ui ordered list">
					...
					<p class="item">El 67% restante del pago deberás consignarlo en la cuenta antes del 10 de marzo de 2015.</p>
